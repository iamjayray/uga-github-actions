<template>
  <main id="main-content" data-cy="user-new-password-view">
    <section class="py-space-lg">
      <div class="container">
        <div class="row">
          <div class="col-12 offset-lg-3 col-lg-6">
            <!-- content-block -->
            <div data-cy="user-new-password-content-block">
            ...
            <base-alert
              ...
              data-cy="new-password-alert"
            ></base-alert>

            <!-- reset-password form block -->
            <div
              id="reset-password-form-block"
              data-cy="user-new-password-reset-password-form-block"
            >
              <b-form
              ...
              >
                <!-- email -->
                <b-form-group
                  data-cy="user-new-password-email-group"
                  id="email-group"
                ...
                <!-- verificationCode -->
                <b-form-group
                  data-cy="user-new-password-verification-code-group"
                ...
                >
                  ...
                  >
                    The verification code can only contain numbers.
                  </b-form-invalid-feedback>
                </b-form-group>

                <!-- password -->
                <b-form-group
                  data-cy="user-new-password-password-group"
                  id="password-group"
                ...
                <div data-cy="user-new-password-return-to-profile">
                  <a
  ...
  methods: {
    ...
    async handleResetPasswordSubmit() {
      ...
      if (response.code === 200) {
        ...
        this.$router.push({ name: EnumPageNames.PageUserNewPasswordConfirm });
      } else {
        // reset form values
